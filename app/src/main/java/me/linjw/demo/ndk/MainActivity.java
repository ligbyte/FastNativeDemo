...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCritical(View view) {
        ...
        Log.d("testtest", "jeek intFromCriticalJNI : " + (System.nanoTime() - time));
    }
    public void onNormal(View view) {
        ...
        Log.d("testtest", "jeek intFromNormalJNI   : " + (System.nanoTime() - time));
    }
    ...
    public void onFastJni(View view) {
        ...
        Log.d("testtest", "jeek intFromFastJNI     : " + (System.nanoTime() - time));
    }
}